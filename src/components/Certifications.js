...
const CertificationCard = ({ title, organization, date, badge, certificateLink }) => {
  ...
  return (
    ...
    >
      ...
      {/* Circular background glow for badge */}
      <motion.div
      ...
      >
        ...
        <motion.a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-4 inline-block text-center px-4 py-2 text-white bg-gradient-to-r from-indigo-600 to-cyan-600 rounded-lg border border-indigo-700/50"
